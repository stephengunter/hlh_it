...
{
   private readonly IIdentityRepository<App> _appRepository;
   private readonly IOpenIddictApplicationManager _applicationManager; 
   private readonly IOpenIddictScopeManager _scopeManager;
   private readonly ICryptoService _cryptoService;
   public AppService(IIdentityRepository<App> appRepository, IOpenIddictApplicationManager applicationManager,
      IOpenIddictScopeManager scopeManager, ICryptoService cryptoService)
   {
   ...
   public async Task RemoveAsync(App entity, string userId)
   {
      ...
      var scope = await _scopeManager.FindByNameAsync(entity.ClientId);
      if (scope != null)
      {
