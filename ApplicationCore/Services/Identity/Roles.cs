...
public class RolesService : IRolesService
{
   ...
   private readonly IIdentityRepository<Role> _rolesRepository;
   public RolesService(IdentityContext context, RoleManager<Role> roleManager, IIdentityRepository<Role> rolesRepository)
   {
