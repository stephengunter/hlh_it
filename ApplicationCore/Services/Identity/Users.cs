...
public class UsersService : IUsersService
{
   ...
   private readonly IIdentityRepository<User> _usersRepository;

   public UsersService(IdentityContext context, UserManager<User> userManager,
   ...
   public async Task SetPasswordAsync(User user, string password)
   {
      ...
      if (!result.Succeeded)
      {
         ...
         throw new Exception($"SetPassword Failed. {msg}");
      }
   }
